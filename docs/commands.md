...
| `--graph` | A tree of what waits for what. Each service sits under the dependency that gates its start, with its readiness condition; other dependencies are noted as `also after`. |
